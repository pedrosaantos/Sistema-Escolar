...
<body class=" bg-dark">
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="../menu.php">Voltar ao Menu</a>
                  </li>
                  <li class="nav-item">
    ...
    <div class="container bg-dark text-light">
        <h1 class="my-3 fs-2 fw-bold">Cadastro de Alunos</h1>
            ...
            <form action="alunos-gravar.php" method="POST">
                ...
                <div class="row my-4">
                    <div class="form-group col-6">
                        <div class="form-floating">
                            <input class="form-control" type="text" name="nomeAluno" id="" required>
                    ...
                    <div class="form-group col-3">
                        <div class="form-floating">
                            <input  class="form-control" type="text" name="cpf" id="cpf" onkeypress="mascaraCPF()" required>
                ...
                <div class="row my-4">
                    <div class="form-group col-2">
                        <div class="form-floating">
                            <input  class="form-control" type="number" name="numero" id="" required>
                ...
                <div class="row my-4 g-2">
                    ...
                    <div class="form-group col-6">
                        <div class="form-floating">  
                            <select name="selturma" class="form-select">                           
                ...
                <div class="row my-4">
                    <div class="col-12">
                        ...
                        <input class="form-check-input mt-2" type="checkbox" name="matricula" id="matricula" checked>
