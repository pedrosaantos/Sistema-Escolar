...
<body class="bg-dark text-light">
    ...
    <main class="container">
        ...
        <h1 class="my-5 fs-2 fw-bold">Atualizar Dados de Disciplinas</h1>

        <form action="disciplinas-editar-gravar.php" method="POST">

            <input type="hidden" name="id" value="<?= $disciplina->id ?>" value="Gravar">

            <div class="row my-5">
                <div class="form-group col-8">
                    <div class="form-floating">
                        <input class="form-control" type="text" name="nomeDisciplina" id="nomeDisciplina"  value="<?= $disciplina->nomeDisciplina ?>" required>
                        <label for="nomeDisciplina">Disciplina:</label>
                    </div>
                </div>
                <div class="form-group col-4">
                    <div class="form-floating">
                        <input  class="form-control" type="number" name="cargaHora" id="cargaHora" value="<?= $disciplina->cargaHora ?>" required>
