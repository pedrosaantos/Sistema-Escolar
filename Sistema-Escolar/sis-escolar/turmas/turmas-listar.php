...
<header class="mb-4">
    ...
    <div class="px-5">
        ...
        <h1 class="my-4 fs-2 fw-bold">Gerenciar Turmas</h1>
            ...
            <table class="table table-dark table-hover table-borderless">
                <thead>
                    <tr class="table-group-divider">
                        ...
                        <th class="fs-4" scope="col">Turma</th>
                        <th class="fs-4" scope="col">Ano</th>
                ...
                <tbody class="text-light">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning" href="turmas-editar.php?id=<?= $linha['id'] ?>" role="button">
                            ...
                            <a class="btn btn-danger" href="turmas-excluir.php?id=<?= $linha['id'] ?>" role="button">
